...
%prep
%setup -q -n gmqtt-0.5.0
cd %{_builddir}/gmqtt-0.5.0
...
cp %{_builddir}/gmqtt-0.5.0/LICENSE %{buildroot}/usr/share/package-licenses/gmqtt/03c27e3e7b67f7256a1223d8c79042655f96cb28
